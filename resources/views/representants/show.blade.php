<x-app-layout>
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                          ...
                          <p class="ml-4 text-xl font-medium text-gray-900">{{ $representant->name }} - Legal Representant</p>
                        </div>
                      </li>
                </ol>
            </nav>
    ...
    @if (session('representantUpdated'))
    <x-green-alert message="{{ session('representantUpdated') }}" />
    @endif
