                ...
                <ol role="list" class="flex items-center space-x-4">
                    <li>
                        <div class="flex items-center">
                            <a href="{{ route('projects.show', ['id'=>$subphase->phase->project->id]) }}"
                                class="ml-4 text-xl font-medium text-gray-500 hover:text-gray-700">{{ $subphase->phase->project->title
                                }}</a>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('projects.phases.show', ['project_id'=>$subphase->phase->project->id, 'phase_id'=>$subphase->phase->id]) }}"
                                class="ml-4 text-xl font-medium text-gray-500 hover:text-gray-700">{{ $subphase->phase->name
                                }}</a>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('projects.phases.subphases.show', ['project_id'=>$subphase->phase->project->id, 'phase_id'=>$subphase->phase->id, 'subphase_id'=>$subphase->id]) }}" class="ml-4 text-xl font-medium text-gray-500 hover:text-gray-700">{{ $subphase->name }}</a>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <p class="ml-4 text-xl font-medium text-gray-800">Edit</p>
                        </div>
                    </li>
                </ol>
            </nav>
                                ...
                                <div>
                                    ...
                                    <fieldset class="mt-4">
                                        <div class="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                                            <div class="flex items-center">
                                                <input id="sms" name="has_documents" type="radio" value="1" {{ $subphase->has_documents ? 'checked' : '' }}
                                                    class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                                <label for="sms"
                                                    class="ml-3 block text-sm font-medium leading-6 text-gray-900">Yes</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input id="push" name="has_documents" type="radio" value="0" required {{ !$subphase->has_documents ? 'checked' : '' }}
                                                    class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                                <label for="push"
