        ...
        <div class="space-y-10 divide-y divide-gray-900/10">
            <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="mt-1 text-sm leading-6 text-gray-600">TPlease provide project information in the form below.</p>
                </div>
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input type="text" name="title" id="title" placeholder="Enter project name here" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                                    </div>
                                </div>
                            </div>
