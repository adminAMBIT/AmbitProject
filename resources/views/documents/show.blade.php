                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <p class="ml-4 text-xl font-medium text-gray-800">{{ $document->name }}</p>
                        </div>
                    </li>
                </ol>
            </nav>
                ...
                <div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
                    ...
                    <div class="ml-4 mt-4 flex-shrink-0">
                        <a href="{{ route('document.edit', ['document_id'=>$document->id]) }}"
                            ...
                            Document</a>
                        <button type="button"
                            class="relative inline-flex items-center rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Manage
                            Feedbacks</button>
                    </div>
                </div>
            </div>
                                    ...
                                    <li>
                                        <div class="relative pb-8">
                                            ...
                                            <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                                <div>
                                                    <p class="text-sm text-gray-500">Applied to Front End
                                                        DeveloperApplied to Front End DeveloperApplied to Front End
                                                        DeveloperApplied to Front End DeveloperApplied to Front End
                                                        DeveloperApplied to Front End DeveloperApplied to Front End
                                                        DeveloperApplied to Front End DeveloperApplied to Front End
                                                        DeveloperApplied to Front End Developer</p>
                                                </div>
